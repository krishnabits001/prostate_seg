...
class dataloaderObj:
    ...
    #define functions to load data from prostate_md dataset
    ...
    def load_prostate_imgs(self, study_id_list,ret_affine=0):
        """
        #Load prostate_md data image and its label with pixel dimensions
        input params :
        ...
        if(self.one_label==1):
            #print('only 1 label')
            label_data_test_sys[label_data_test_sys>=2]=1
    ...
    #    """
    #    # Load the already created and stored a-priori prostate_md data and its labels that are preprocessed and cropped to given dimensions
    #    input params :
